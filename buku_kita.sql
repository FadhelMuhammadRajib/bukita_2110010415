...
(4, 'One Piece Volume 200', 'Gramedia', 'Echiro Oda', '2005', 5, 30000);
...
(1, 'Fadhel Rajib', 'Fadhel', '0123'),
(2, 'Slamet', 'Memet', '01234');
...
--
ALTER TABLE `user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2110010416;
